...
public class Clase {
	...
	public Clase(String nombre, Date fecha, Date horaInicio, String url, Date fechaRegistro, byte[] imagen) {
		super();
		this.nombre = nombre;
		this.fecha = fecha;
	...
	public DtClase getDtClase() {
		return new DtClase(this.getNombre(), this.getFecha(), this.getHoraInicio(), this.getUrl(),this.getFechaRegistro(),this.getImagen(), this.getDtregistros(),this.getNicknameProfe(),this.getDtActdep());
	}
